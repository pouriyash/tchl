...
{
    public static class RegatePersianDatePickerMaterial
    {
        public static string Build(string name, string labelName, DateTime? value = null, bool isRequired = true)
        {
            var uniqueId = "RegatePersianDatePickerMaterial__" + name + "__" + Guid.NewGuid().ToString().Replace("-", "");
            ...
            var markup = $@"
                ...
                <div class='calendar-container'>
                    ...
                    <i id='{uniqueIdClear}' class='fa fa-times padding-left-10' data-role='clear'></i>
                </div>
            ...
            var initScript = @"
                <script>
                    function initRegatePersianDatePickerMaterial(name, uniqueId, uniqueIdPicker, uniqueIdHidden, uniqueIdClear, defaultDateJalali) {
            ...
            var script = $@"
                <script>
                    initRegatePersianDatePickerMaterial('{name}', '{uniqueId}', '{uniqueIdPicker}', '{uniqueIdHidden}', '{uniqueIdClear}', '{defaultDateJalali}')
                </script>
            ";
