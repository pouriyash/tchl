...
(function ($) {
  ...
  function createPersianDateTimePickerHtml($popoverDescriber, dateTimeInJsonFormat, writeDateString, initializing) {
    ...
    for (var k = yearForDropDown - 90; k <= yearForDropDown + 90; k++) {
    ...
    init: function (options) {
      ...
      return this.each(function () {
        ...
        $this.popover({
          ...
          title: 'انتخاب تاریخ',
          trigger: 'manual',
          template: '<div class="popover zIndexCorrected persianDateTimePicker" role="tooltip"><div class="arrow"></div><h3 class="popover-title" data-name="md-datetimepicker-title" data-isgregorian="' + settings.IsGregorian + '"></h3><div class="popover-content" data-name="md-datetimepicker-popovercontent"></div></div>'
