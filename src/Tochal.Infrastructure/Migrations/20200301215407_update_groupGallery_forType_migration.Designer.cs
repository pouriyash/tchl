...
namespace Tochal.Infrastructure.Migrations
{
    ...
    [Migration("20200301215407_update_groupGallery_forType_migration")]
    partial class update_groupGallery_forType_migration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tochal.Core.DomainModels.Entity.Blog.ContentEntity", b =>
                {
                    ...
                    b.Property<string>("MainImageThubNail");
            ...
            modelBuilder.Entity("Tochal.Core.DomainModels.Entity.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Tochal.Core.DomainModels.Entity.ContactUs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Tochal.Core.DomainModels.Entity.Content.Gallery", b =>
                {
                    ...
                    b.Property<bool?>("FirstImage");

                    b.Property<int>("GroupGalleryId");

                    b.Property<string>("Image");

                    b.HasKey("Id");

                    b.HasIndex("GroupGalleryId");

                    b.ToTable("Gallery");
                });

            modelBuilder.Entity("Tochal.Core.DomainModels.Entity.Content.GalleryEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("GalleryContentType");
            ...
            modelBuilder.Entity("Tochal.Core.DomainModels.Entity.Content.GroupGallery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Tochal.Core.DomainModels.Entity.Language", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("Tochal.Core.DomainModels.Entity.Season", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("AutumnContent");

                    b.Property<string>("AutumnHeaderImage");

                    b.Property<string>("AutumnHeaderMobileImage");

                    b.Property<string>("AutumnShortDescription");

                    b.Property<string>("AutumnTitle");

                    b.Property<string>("SpringContent");

                    b.Property<string>("SpringHeaderImage");

                    b.Property<string>("SpringHeaderMobileImage");

                    b.Property<string>("SpringShortDescription");

                    b.Property<string>("SpringTitle");

                    b.Property<string>("SummerContent");

                    b.Property<string>("SummerHeaderImage");

                    b.Property<string>("SummerHeaderMobileImage");

                    b.Property<string>("SummerShortDescription");

                    b.Property<string>("SummerTitle");

                    b.Property<string>("WinterContent");

                    b.Property<string>("WinterHeaderImage");

                    b.Property<string>("WinterHeaderMobileImage");

                    b.Property<string>("WinterShortDescription");

                    b.Property<string>("WinterTitle");
            ...
            modelBuilder.Entity("Tochal.Core.DomainModels.Entity.Blog.ContentEntity", b =>
                {
                    b.HasOne("Tochal.Core.DomainModels.Entity.Language", "Language")
                        .WithMany()
            ...
            modelBuilder.Entity("Tochal.Core.DomainModels.Entity.Content.Gallery", b =>
                {
                    b.HasOne("Tochal.Core.DomainModels.Entity.Content.GroupGallery")
                        .WithMany("Galleries")
                        .HasForeignKey("GroupGalleryId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("Tochal.Core.DomainModels.Entity.Content.GalleryEntity", b =>
                {
                    b.HasOne("Tochal.Core.DomainModels.Entity.Content.GroupGallery", "GroupGallery")
                        .WithMany()
            ...
            modelBuilder.Entity("Tochal.Core.DomainModels.Entity.Content.GroupGallery", b =>
                {
                    b.HasOne("Tochal.Core.DomainModels.Entity.Content.Gallery", "Gallery")
                        .WithMany()
