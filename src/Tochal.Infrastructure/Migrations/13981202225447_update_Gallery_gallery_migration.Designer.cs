...
namespace Tochal.Infrastructure.Migrations
{
    ...
    [Migration("13981202225447_update_Gallery_gallery_migration")]
    partial class update_Gallery_gallery_migration
    {
            ...
            modelBuilder.Entity("Tochal.Core.DomainModels.Entity.Content.GroupGallery", b =>
                {
                    ...
                    b.HasOne("Tochal.Core.DomainModels.Entity.Content.GalleryEntity")
                        .WithMany("GroupGalleries")
